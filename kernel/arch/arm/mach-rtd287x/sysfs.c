...
{
	char fmt[16];
	sprintf(fmt, "%%%ds", sizeof(platform_info.sched_log_name)-1);
...
#define POWER_ON_RESOURCE_ADDR                      (0x086ff000)     // 086ff000~0870_0000
...
#define DDC_U2R_ENABLE DDC_CTRL_DDC_U2R_USE_DDC2
	if (value)
	{
