/**
* @file Merlin3-DesignSpec-Standby
...
#define  STB_SC_ANA_CTRL_rint_sel_en_shift                                       (18)
#define  STB_SC_ANA_CTRL_rint_cal_en_shift                                       (17)
#define  STB_SC_ANA_CTRL_rint_cal_shift                                          (12)
#define  STB_SC_ANA_CTRL_mbias_shift                                             (0)
#define  STB_SC_ANA_CTRL_rint_sel_en_mask                                        (0x00040000)
#define  STB_SC_ANA_CTRL_rint_cal_en_mask                                        (0x00020000)
#define  STB_SC_ANA_CTRL_rint_cal_mask                                           (0x0001F000)
#define  STB_SC_ANA_CTRL_mbias_mask                                              (0x000001FF)
#define  STB_SC_ANA_CTRL_rint_sel_en(data)                                       (0x00040000&((data)<<18))
#define  STB_SC_ANA_CTRL_rint_cal_en(data)                                       (0x00020000&((data)<<17))
#define  STB_SC_ANA_CTRL_rint_cal(data)                                          (0x0001F000&((data)<<12))
#define  STB_SC_ANA_CTRL_mbias(data)                                             (0x000001FF&(data))
#define  STB_SC_ANA_CTRL_get_rint_sel_en(data)                                   ((0x00040000&(data))>>18)
#define  STB_SC_ANA_CTRL_get_rint_cal_en(data)                                   ((0x00020000&(data))>>17)
#define  STB_SC_ANA_CTRL_get_rint_cal(data)                                      ((0x0001F000&(data))>>12)
