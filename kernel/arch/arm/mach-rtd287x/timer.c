...
{TIMER_TC0TVR_reg, TIMER_TC0CVR_reg, TIMER_TC0CR_reg, TIMER_TC0ICR_reg, TIMER_ISR_tc0_int_shift},
{TIMER_TC1TVR_reg, TIMER_TC1CVR_reg, TIMER_TC1CR_reg, TIMER_TC1ICR_reg, TIMER_ISR_tc1_int_shift},
{TIMER_TC2TVR_reg, TIMER_TC2CVR_reg, TIMER_TC2CR_reg, TIMER_TC2ICR_reg, TIMER_ISR_tc2_int_shift},
{TIMER_TC3TVR_reg, TIMER_TC3CVR_reg, TIMER_TC3CR_reg, TIMER_TC3ICR_reg, TIMER_ISR_tc3_int_shift},
{TIMER_TC4TVR_reg, TIMER_TC4CVR_reg, TIMER_TC4CR_reg, TIMER_TC4ICR_reg, TIMER_ISR_tc4_int_shift},
{TIMER_TC5TVR_reg, TIMER_TC5CVR_reg, TIMER_TC5CR_reg, TIMER_TC5ICR_reg, TIMER_ISR_tc5_int_shift},
{TIMER_TC6TVR_reg, TIMER_TC6CVR_reg, TIMER_TC6CR_reg, TIMER_TC6ICR_reg, TIMER_ISR_tc6_int_shift},
{TIMER_TC7TVR_reg, TIMER_TC7CVR_reg, TIMER_TC7CR_reg, TIMER_TC7ICR_reg, TIMER_ISR_tc7_int_shift},
{TIMER_TC8TVR_reg, TIMER_TC8CVR_reg, TIMER_TC0CR_reg, TIMER_TC0ICR_reg, TIMER_ISR_tc8_int_shift},
{TIMER_TC9TVR_reg, TIMER_TC9CVR_reg, TIMER_TC1CR_reg, TIMER_TC0ICR_reg, TIMER_ISR_tc9_int_shift},
{TIMER_TC10TVR_reg, TIMER_TC10CVR_reg, TIMER_TC2CR_reg, TIMER_TC0ICR_reg, TIMER_ISR_tc10_int_shift},
{TIMER_TC11TVR_reg, TIMER_TC11CVR_reg, TIMER_TC3CR_reg, TIMER_TC0ICR_reg, TIMER_ISR_tc11_int_shift},
};
...
int rtk_timer_set_mode(unsigned char id, unsigned char mode)
{
	...
	if(id < 8)
		set_value = TIMERINFO_TIMER_MODE;
	else
		set_value = (TIMERINFO_TIMER_MODE >> (16));

	if(mode == TIMER) //TIMER mode
		rtd_setbits(sys_timer[id].cr, set_value);
	else //COUNTER mode
		rtd_clearbits( sys_timer[id].cr, set_value);
...
static void rtk_timer_set_interrupt(unsigned char id, bool enable)
{
	...
	if(id < 8)
		set_value = TIMERINFO_INTERRUPT_ENABLE;
	else //BIT31(Timer0), Bit30(Timer8), Bit29(Timer9), Bit28(Timer10), Bit27(Timer11)
		set_value = (TIMERINFO_INTERRUPT_ENABLE >> (id-7));

	if(enable)
		rtd_setbits(sys_timer[id].icr, set_value);
	else
		rtd_clearbits(sys_timer[id].icr, set_value);
}
...
static void rtk_timer_set_hwt_enable(unsigned id, bool enable)
{
	...
	if(id < 8)
		set_value = TIMERINFO_TIMER_ENABLE;
	else
		set_value = (TIMERINFO_TIMER_ENABLE >> (16));
...
static void rtk_timer_set_hwt_pause(unsigned id, bool pause)
{
	...
	if(id < 8)
		set_value = TIMERINFO_TIMER_PAUSE;
	else
		set_value = (TIMERINFO_TIMER_PAUSE >> (16));
                        ...
                        struct clock_event_device *unused)
{
    ...
    rtk_timer_set_interrupt(SYSTEM_TIMER, 1);
...
static u64 rtk_hpt_read(struct clocksource *cs)
{
...
//  sched_log_time_scale = est_freq;
    ...
    // configure coresight CNTCR
#ifndef CONFIG_OPTEE 
    //following access will have problem after burn OTP TZ field
    rtd_outl(WRAP_A7_APB_TSG_EN0, 0);
    rtd_outl(WRAP_A7_APB_TSG_EN1, 1);
