...
unsigned long carvedout_buf[MM_LAYOUT_CARVEDOUT_NUM][CARVEDOUT_NUM][2] = {
  // MM_LAYOUT_DEFAULT
  {
	...
	{DTV_VIDEO_RINGBUFFER_START, DTV_VIDEO_RINGBUFFER_SIZE}, // CARVEDOUT_DTV_VDEC_RINGBUF
  ...
  // MM_LAYOUT_1GB
  {
	...
	{_TBD_, _TBD_}, // CARVEDOUT_DTV_VDEC_RINGBUF
#ifdef CONFIG_REALTEK_LOGBUF
...
static const char *carvedout_mem_dts_name[CARVEDOUT_NUM] = {
	...
	"dtv_vdec_ringbuffer", // CARVEDOUT_DTV_VDEC_RINGBUF
#ifdef CONFIG_REALTEK_LOGBUF
