/**
* @file Merlin4-DesignSpec-ISO_MISC_OFF_arch_spec
...
#define  ISO_MISC_OFF_SYSTEM_i2c_scpu_int_en_shift                               (24)
#define  ISO_MISC_OFF_SYSTEM_i2c_8051_int_en_shift                               (20)
...
#define  ISO_MISC_OFF_SYSTEM_i2c_scpu_int_en_mask                                (0x01000000)
#define  ISO_MISC_OFF_SYSTEM_i2c_8051_int_en_mask                                (0x00100000)
...
#define  ISO_MISC_OFF_SYSTEM_i2c_scpu_int_en(data)                               (0x01000000&((data)<<24))
#define  ISO_MISC_OFF_SYSTEM_i2c_8051_int_en(data)                               (0x00100000&((data)<<20))
...
#define  ISO_MISC_OFF_SYSTEM_get_i2c_scpu_int_en(data)                           ((0x01000000&(data))>>24)
#define  ISO_MISC_OFF_SYSTEM_get_i2c_8051_int_en(data)                           ((0x00100000&(data))>>20)
...
typedef union
{
    ...
    struct{
        RBus_UInt32  res1:7;
        RBus_UInt32  i2c_scpu_int_en:1;
        RBus_UInt32  res2:3;
        RBus_UInt32  i2c_8051_int_en:1;
        RBus_UInt32  res3:3;
