...
typedef struct
{
	...
	UBYTE   u5_fadeInOut_dh_close_thr          ;
	UBYTE   u5_fadeInOut_logo_close_thr        ;
	...
	UBYTE	 u4_dyn_SAD_Diff_rmv_ratio_th_l;
	UBYTE	 u4_dyn_SAD_Diff_rmv_ratio_th_h;
	UBYTE	 u6_dyn_SAD_Diff_gmv_ratio_th;
	...
	UBYTE  u1_zmv_adapt_pnt_en;
	UBYTE  u11_zmv_adapt_pnt_GMV_mvx_thr;
	UBYTE  u10_zmv_adapt_pnt_GMV_mvy_thr;
	UINT32 u13_zmv_adapt_pnt_GMV_Small_Y1;
	UINT32 u13_zmv_adapt_pnt_GMV_Big_Y1;

	UBYTE  u1_me1_gmvd_sel_en;
	UBYTE  u11_me1_gmvd_sel_mvx_diff_thr;
	UBYTE  u10_me1_gmvd_sel_mvy_diff_thr;
	UBYTE  u4_me1_gmvd_sel_1st_gmv_ratio_thr;
	UBYTE  u4_me1_gmvd_sel_2nd_gmv_ratio_thr;

	//Scene analysis
	UBYTE  u1_SA_en;
	UINT32 u20_SA_good_rgn_SAD_th;
	UINT32 u12_SA_good_rgn_unconf_th;
	UINT32 u12_SA_good_rgn_TC_th;
	UBYTE  u5_SA_good_rgn_num_th;
	UBYTE  u5_SA_bad_rgn_num_th;
	UBYTE  u4_SA_good_scene_enter_cnt;
	UBYTE  u4_SA_bad_scene_enter_cnt;
	UINT32 u20_SA_bad_rgn_SAD_th;
	UINT32 u12_SA_bad_rgn_unconf_th;
	UINT32 u12_SA_bad_rgn_TC_th;
	UBYTE  u3_SA_bad_scene_keep_cnt;

	//hold frame of pfv cdd after SC
	UBYTE  u8_SC_PFV_CDD_hold_cnt;

	// dynamic mv accord
	UBYTE  u1_mv_accord_en;
	UBYTE  u6_mv_accord_hold_cnt;
	UBYTE  u6_mv_accord_mvx_thr;
	UBYTE  u5_mv_accord_mvy_thr;
	UBYTE  u6_mv_accord_gmv_ratio_thr;
...
typedef struct
{
	...
	UBYTE   u8_dynME2_acdc_bld_x_act[3]            ;
	UBYTE   u6_dynME2_acdc_bld_y_act[3]            ;
	SINT16  s9_dynME2_acdc_bld_s_act[2]            ;
	...
	UBYTE  u1_zmv_adapt_pnt_GMV_Small;

	//Scene analysis
	UBYTE  u8_SA_good_scene_cnt;
	UBYTE  u1_SA_good_scene;
	UBYTE  u8_SA_bad_scene_cnt;
	UBYTE  u1_SA_bad_scene;
	UBYTE  u3_SA_bad_scene_keep_cnt;
	...
	// dynamic mv accord
	UBYTE  u1_mv_accord_on;
	UBYTE  u6_mv_accord_hold_cnt;

	UBYTE  u1_RgRotat_true;
	UBYTE  u4_RgRotat_cnt;

	UBYTE  u1_Zoom_true;
	UBYTE  u4_ZoomIn_cnt;
	UBYTE  u4_ZoomOut_cnt;

	UBYTE  u1_Swing_true;
	UBYTE  u4_SwingRight_cnt;
	UBYTE  u4_SwingLeft_cnt;
	...
	UBYTE u8_VOSeek_prt_logo_apply;
...
DEBUGMODULE_BEGIN(_PARAM_FRC_SceneAnalysis, _OUTPUT_FRC_SceneAnalysis)
	...
	ADD_OUTPUT_ARRAY_DES(UBYTE,  u8_dynME2_acdc_bld_x_act, 3, "")
	ADD_OUTPUT_ARRAY_DES(UBYTE,  u6_dynME2_acdc_bld_y_act, 3, "")
	ADD_OUTPUT_ARRAY_DES(SINT16, s9_dynME2_acdc_bld_s_act, 2, "")
