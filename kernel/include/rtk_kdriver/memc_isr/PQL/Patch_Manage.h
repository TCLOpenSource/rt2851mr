...
{
        //// HF1
	UBYTE u1_HF1_Detect_en;
	UBYTE u8_HF1_Hdtl_thr_gain;
	UBYTE u8_HF1_Vdtl_thr_gain;
	UBYTE u8_HF1_mvx_thr;
	UBYTE u7_HF1_mvy_thr;
	
	//// HF2
	UBYTE u1_HF2_Detect_en;
	UBYTE u8_HF2_Hdtl_thr_gain;
	UBYTE u8_HF2_Vdtl_thr_gain;
	UBYTE u8_HF2_mvx_thr;
	UBYTE u7_HF2_mvy_thr;	

	//// HF3
	UBYTE u1_HF3_Detect_en;
	UBYTE u8_HF3_Hdtl_thr_gain;
	UBYTE u8_HF3_Vdtl_thr_gain;
	UBYTE u8_HF3_mvx_thr;
	UBYTE u7_HF3_mvy_thr;	

	//// RidingHorse
	UBYTE u1_RidingHorse_Detect_en;
	UBYTE u8_RidingHorse_Uamount_thr_gain;
	UBYTE u8_RidingHorse_Vamount_thr_gain;
	UBYTE u8_RidingHorse_mvx_thr;
	UBYTE u7_RidingHorse_mvy_thr;	
        //====================
...
{
        //// HF1
	UBYTE u1_HF1_Detected;
	UBYTE u6_HF1_hold_cnt;

	//// HF2
	UBYTE u1_HF2_Detected;
	UBYTE u6_HF2_hold_cnt;

	//// HF3
	UBYTE u1_HF3_Detected;
	UBYTE u6_HF3_hold_cnt;

	//// HF3
	UBYTE u1_RidingHorse_Detected;
	UBYTE u6_RidingHorse_hold_cnt;
        //============================
