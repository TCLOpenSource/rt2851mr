...
typedef struct  
{
	...
	UINT32 u32_Mot_sequence_for_mixmode; //only Film_all
	UBYTE  u1_Mot_selBig;
	...
	/////
	UBYTE  u8_det_cadence_Id_pre[_FILM_MOT_NUM]; // pre detected cadence according to motion sequence.
	...
	UBYTE  u8_phase_Idx_tmp[_FILM_MOT_NUM];
