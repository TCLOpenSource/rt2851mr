...
typedef struct
{
	...
	UBYTE  u8_badRgn_dtl_thr1;
	UBYTE  u8_badRgn_dtl_thr2;
	UBYTE  u8_badRgn_dtl_gain1;
	UBYTE  u8_badRgn_dtl_gain2;
...
typedef struct
{
	...
	UBYTE u2_rFB_alpha_mode;
	UBYTE u8_rFB_alpha_curve_gain;
	UBYTE u8_rFB_alpha_curve_th0;
	UBYTE u8_rFB_alpha_curve_slp;
	UBYTE u8_rFB_alpha_curve_min;
	UBYTE u8_rFB_alpha_curve_max;
	bool  u1_rFB_alpha_auto;
	bool  u1_rFB_level_auto;
	UBYTE u8_rFB_alpha_force_value;
	UBYTE u8_rFB_level_force_value;
	UBYTE u8_rFB_level_curve_gain;
	UBYTE u8_rFB_level_curve_th0;
	UBYTE u8_rFB_level_curve_slp;
	UBYTE u8_rFB_level_curve_min;
	UBYTE u8_rFB_level_curve_max;	
	UBYTE u1_rFB_alpha_by_dtl_en;	
	UBYTE u1_rFB_alpha_by_rMV_cnt_en;
	UBYTE u8_big_rMV_thl;
	...
	UBYTE u8_rFB_panning_unconf_thl;
	UBYTE u8_rFB_panning_cnt_thl;

	//o------ rmv blending ------o
	UBYTE  u2_rmv_alpha_mode;
	UBYTE  u8_rmv_alpha_curve_gain;
	UBYTE  u8_rmv_alpha_curve_th0;
	UBYTE  u8_rmv_alpha_curve_slp;	
	UBYTE  u8_rmv_alpha_curve_min;
	UBYTE  u8_rmv_alpha_curve_max;
	bool   u1_gmv_alpha_auto;
	UBYTE  u8_gmv_alpha_force_value;
	UINT16 u12_regional_unconf_thl;
	UINT16 u12_regional_cnt_thl;
	UBYTE  u8_regioonal_unconf_cnt_th;
	UBYTE  u8_oppo_dir_cnt_thl;
	UBYTE  u8_rmv_var_thl;
	UBYTE  u8_gmv_cur_gain;
	UBYTE  u8_gmv_cur_slp;

}_PARAM_bRMV_rFB_CTRL;

typedef struct
{
	UINT16 u10_fb_rgn00_mvy[32];
	UINT16 u11_fb_rgn00_mvx[32];
	UBYTE  u8_fb_rmv_alpha[32];
	UBYTE  u8_rFB_level[32];
	UBYTE  u8_rFB_alpha[32];
	bool   u1_rFB_panning;
