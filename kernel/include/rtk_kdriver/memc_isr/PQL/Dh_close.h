...
typedef struct
{
	...
	UBYTE  u1_pfv_cdd_num_en;
	UBYTE  u5_phfv0_candi_num;
	UBYTE  u5_phfv1_candi_num;
	UINT16 u9_pfv_cdd_num_dtl_thr;
	
	UBYTE  u2_dh_me1_ip_dc_obme_mode_off;
	UBYTE  u2_dh_me1_pi_dc_obme_mode_off;
	UBYTE  u2_dh_me1_ip_ac_obme_mode_off;
	UBYTE  u2_dh_me1_pi_ac_obme_mode_off;

	UBYTE  u2_dh_me1_ip_dc_obme_mode_on;
	UBYTE  u2_dh_me1_pi_dc_obme_mode_on;
	UBYTE  u2_dh_me1_ip_ac_obme_mode_on;
	UBYTE  u2_dh_me1_pi_ac_obme_mode_on;
