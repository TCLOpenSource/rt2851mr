...
typedef struct _I2RND_SCPU_VIR_START_ADDR {
	unsigned int    s0_vo_st_vir_addr; //0xb8005000 - 0xb8005288
	unsigned int    s0_vgip_st_vir_addr;//b8028022200 - b80222e0
	unsigned int	s0_color_mb_peaking_st_vir_addr;
	unsigned int	s0_dexcxl_st_vir_addr; //0xb8023900 - 0xb80239e4
	unsigned int	s0_dfilter_st_vir_addr;
	unsigned int	s0_di0_st_vir_addr;//b8024000-b8024bf4
	unsigned int	s0_di1_st_vir_addr;//b8024000-b8024bf4
	unsigned int	s0_di2_st_vir_addr;//b8024000-b8024bf4
	unsigned int	s0_di3_st_vir_addr;//b8024000-b8024bf4
	unsigned int	s0_di4_st_vir_addr;//b8024000-b8024bf4
	unsigned int	s0_di5_st_vir_addr;//b8024000-b8024bf4
	unsigned int	s0_di6_st_vir_addr;//b8024000-b8024bf4
	unsigned int	s0_histogram_st_vir_addr;//0xb802_3200  ~ 0xb802_3338
	unsigned int	s0_hsddither_st_vir_addr;//b8022600 -b8022668
	unsigned int	s0_idcti_st_vir_addr;//0xb80231d4- 0xb80231f8
	unsigned int	s0_iedgesmooth_st_vir_addr;//b8025100-b80251ec
	unsigned int	s0_ipq_decontour_st_vir_addr;//0xb8025700 - 0xb802575c
	unsigned int	s0_main_dither_st_vir_addr;
	unsigned int	s0_mpegnr_st_vir_addr;//0xb8023820 -0xb80238fc
	unsigned int	s0_nr0_st_vir_addr;//b8025000-b80250ff
	unsigned int	s0_nr1_st_vir_addr;//b8025500-b80255ff
	unsigned int	s0_peaking_st_vir_addr;
	unsigned int	s0_profile0_st_vir_addr;//0xb802_3400  ~ 0xb802_34FF
	unsigned int	s0_profile1_st_vir_addr;//b8024000-b8024bf4
	unsigned int	s0_rgb2yuv0_st_vir_addr;// 0xb8023000, b8023008~b802301c,0xb8023038
	unsigned int	s0_rgb2yuv1_st_vir_addr;
	unsigned int	s0_ringfilter_st_vir_addr;//-0xb8023580 - 0xb8023590
	unsigned int    s0_uzd0_st_vir_addr;//b8025204-b802537c
	unsigned int    s0_uzd1_st_vir_addr;
	unsigned int    s0_mcap0_st_vir_addr;//0xb8027200 - 0xb802722c;b802726c~b8027280;b80272c8~b80272cc;b80272e0~b80272ec;
	unsigned int    s0_mcap1_st_vir_addr;
	unsigned int    s0_mcap2_st_vir_addr;
	unsigned int    s0_vtop0_st_vir_addr;
	unsigned int    s0_vtop1_st_vir_addr;

	unsigned int    s1_vo_st_vir_addr; //0xb8005000 - 0xb8005288
	unsigned int    s1_vgip_st_vir_addr;//b8028022200 - b80222e0
	unsigned int	s1_color_mb_peaking_st_vir_addr;
	unsigned int	s1_dexcxl_st_vir_addr; //0xb8023900 - 0xb80239e4
	unsigned int	s1_dfilter_st_vir_addr;
	unsigned int	s1_di0_st_vir_addr;//b8024000-b8024bf4
	unsigned int	s1_di1_st_vir_addr;//b8024000-b8024bf4
	unsigned int	s1_di2_st_vir_addr;//b8024000-b8024bf4
	unsigned int	s1_di3_st_vir_addr;//b8024000-b8024bf4
	unsigned int	s1_di4_st_vir_addr;//b8024000-b8024bf4
	unsigned int	s1_di5_st_vir_addr;//b8024000-b8024bf4
	unsigned int	s1_di6_st_vir_addr;//b8024000-b8024bf4
	unsigned int	s1_histogram_st_vir_addr;//0xb802_3200  ~ 0xb802_3338
	unsigned int	s1_hsddither_st_vir_addr;//b8022600 -b8022668
	unsigned int	s1_idcti_st_vir_addr;//0xb80231d4- 0xb80231f8
	unsigned int	s1_iedgesmooth_st_vir_addr;//b8025100-b80251ec
	unsigned int	s1_ipq_decontour_st_vir_addr;//0xb8025700 - 0xb802575c
	unsigned int	s1_main_dither_st_vir_addr;
	unsigned int	s1_mpegnr_st_vir_addr;//0xb8023820 -0xb80238fc
	unsigned int	s1_nr0_st_vir_addr;//b8025000-b80250ff
	unsigned int	s1_nr1_st_vir_addr;//b8025500-b80255ff
	unsigned int	s1_peaking_st_vir_addr;
	unsigned int	s1_profile0_st_vir_addr;//0xb802_3400  ~ 0xb802_34FF
	unsigned int	s1_profile1_st_vir_addr;//b8024000-b8024bf4
	unsigned int	s1_rgb2yuv0_st_vir_addr;// 0xb8023000, b8023008~b802301c,0xb8023038
	unsigned int	s1_rgb2yuv1_st_vir_addr;
	unsigned int	s1_ringfilter_st_vir_addr;//-0xb8023580 - 0xb8023590
	unsigned int    s1_uzd0_st_vir_addr;//b8025204-b802537c
	unsigned int    s1_uzd1_st_vir_addr;
	unsigned int    s1_mcap0_st_vir_addr;//0xb8027200 - 0xb802722c;b802726c~b8027280;b80272c8~b80272cc;b80272e0~b80272ec;
	unsigned int    s1_mcap1_st_vir_addr;
	unsigned int    s1_mcap2_st_vir_addr;
	unsigned int    s1_vtop0_st_vir_addr;
	unsigned int    s1_vtop1_st_vir_addr;

	unsigned int	i2rnd_enable_vir_addr;//in2rnd enable flag
	unsigned int	i2rnd_write_cmd_vir_addr;
	unsigned int	i2rnd_read_cmd_vir_addr;
	unsigned int	i2rnd_pst_pnt_counter_vir_addr;
	unsigned int	i2rnd_force_write_cmd_addr;
	unsigned int	i2rnd_s1_write_cmd_vir_addr;
	unsigned int	i2rnd_s1_read_cmd_vir_addr;
	unsigned int	i2rnd_s1_pst_pnt_counter_vir_addr;
	unsigned int	i2rnd_vo1_refine_status_vir_addr;
	unsigned int	i2rnd_s0_idomain_done_status_vir_addr;
}I2RND_SCPU_VIR_START_ADDR;
#endif
...
void set_i2rnd_s0_pst_check_stage(unsigned int cnt);
unsigned int get_i2rnd_s0_pst_check_stage(void);
...
void set_i2rnd_s0_pst_check_stage(unsigned int cnt);
void set_i2rnd_s1_pst_check_stage(unsigned int cnt);
unsigned int get_i2rnd_s0_pst_check_stage(void);
unsigned int get_i2rnd_s1_pst_check_stage(void);
