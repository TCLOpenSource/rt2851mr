...
void PipmpSetSubMuteWindow(unsigned short DispHSta, unsigned short DispHAct, unsigned short DispVSta, unsigned short DispVAct);//this api is for sub mute off to set window. ANDROIDTV-2297 issue
void initial_sub_window_ctrl_semaphore(void);//initial sub window semaphore
#ifdef __cplusplus
}
#endif
