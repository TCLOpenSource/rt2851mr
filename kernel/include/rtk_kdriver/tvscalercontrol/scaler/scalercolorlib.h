...
//>>> [M6PRTANPM-1556] Dolby SDK2.1.1 GDNB items control pwm_duty by A/P dimming 
...
typedef struct _KADP_VPQ_dolby_backlight {
    unsigned int dolby_adimming;
    unsigned int dolby_pdimming;
} KADP_VPQ_dolby_backlight;
