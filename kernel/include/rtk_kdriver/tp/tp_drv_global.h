...
extern UINT8 tp_tlv_file_path[MAX_TP_COUNT][256];

extern struct   file *rec_filter_tlv_fd[MAX_TP_COUNT];
extern UINT8 tp_filter_tlv_file_path[MAX_TP_COUNT][256];
...
#define TP_PROC_PARAM_RECORD_TLV_EN        "record_orgtlv_en="           /*  start & stop record tlv from TP ring buffer (0: stop record; 1: start record) */
...
#define TP_PROC_PARAM_SET_RCD_OFFSET             "rcd_offset=" 
