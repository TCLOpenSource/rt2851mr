...
#define TP_IOC_PCR_CNT_SET_INFO           _IOWR(TP_IOC_MAGIC, TP_PCR_START+3, TP_PCR_CNT_SET_INFO_T*)
#define TP_IOC_PCR_STC_INFO               _IOWR(TP_IOC_MAGIC, TP_PCR_START+4, TP_PCR_STC_INFO_T*)
...
#define TP_IOC_TPP_MTP_STREAM_CONTROL         _IOW(TP_IOC_MAGIC,TP_CIPLUS_START+3, TP_IOC_TPP_STREAM_CONTROL_T*)
