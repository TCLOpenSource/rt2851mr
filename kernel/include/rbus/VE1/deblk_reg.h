...
#define  DEBLK_HEVCDBPAR2_dmy_row_ctb_src(data)                                  ((0x00000080&(data))>>7)
#define  DEBLK_HEVCDBPAR2_dmy_clm_ctb_src(data)                                  ((0x00000040&(data))>>6)
#define  DEBLK_HEVCDBPAR2_mb_num_src(data)                                       (0x0000003F&(data))

#define  DEBLK_EXTRA_CTRL                                                       0x1800EAF8
#define  DEBLK_EXTRA_CTRL_reg_addr                                               "0xB800EAF8"
#define  DEBLK_EXTRA_CTRL_reg                                                    0xB800EAF8
#define  DEBLK_EXTRA_CTRL_inst_adr                                               "0x00BE"
#define  DEBLK_EXTRA_CTRL_inst                                                   0x00BE
...
#define  DEBLK_EXTRA_CTRL_bits_src(data)                                         ((0xFFFFFFE0&(data))>>5)
#define  DEBLK_EXTRA_CTRL_dmy_row_delay_src(data)                                (0x0000001F&(data))
