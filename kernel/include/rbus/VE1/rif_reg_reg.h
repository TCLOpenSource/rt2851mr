...
#define  RIF_REG_VE_CTRL_ve_only_fpga_reset_src(data)                            ((0x40000000&(data))>>30)
...
#define  RIF_REG_VE_CTRL_IntEn_vcpu2_src(data)                                   ((0x00000200&(data))>>9)
...
#define  RIF_REG_VE_INT_STATUS_ve_blk_wrap_int_src(data)                         ((0x20000000&(data))>>29)
...
#define  RIF_REG_VE_INT_EN_ve_blk_wrap_ie_src(data)                              ((0x02000000&(data))>>25)
...
#define  RIF_REG_DEC_CNTL_decimate_en_src(data)                                  ((0x80000000&(data))>>31)
...
#define  RIF_REG_PICINFO1_decimate_ratio_src(data)                               ((0xC0000000&(data))>>30)
...
#define  RIF_REG_H264PICCNTL_inc_cah_head_bl_src(data)                           ((0x00040000&(data))>>18)
#define  RIF_REG_H264PICCNTL_inc_cah_data_bl_src(data)                           ((0x00020000&(data))>>17)
#define  RIF_REG_H264PICCNTL_ch_comp_wrap_width_src(data)                        ((0x0001FF80&(data))>>7)
...
#define  RIF_REG_VC1PICCNTL2                                                    0x1800E42C
#define  RIF_REG_VC1PICCNTL2_reg_addr                                            "0xB800E42C"
#define  RIF_REG_VC1PICCNTL2_reg                                                 0xB800E42C
#define  RIF_REG_VC1PICCNTL2_inst_adr                                            "0x000B"
#define  RIF_REG_VC1PICCNTL2_inst                                                0x000B
...
#define  RIF_REG_BRG_CTRL_neighbor_loc_src(data)                                 ((0x3F000000&(data))>>24)
...
#define  RIF_REG_RD_PRIORITY0_vm2_src(data)                                      ((0x1FFF0000&(data))>>16)
#define  RIF_REG_RD_PRIORITY0_vm1_src(data)                                      (0x00001FFF&(data))
...
#define  RIF_REG_RD_PRIORITY1_deblk_src(data)                                    ((0x1FFF0000&(data))>>16)
#define  RIF_REG_RD_PRIORITY1_predblk_src(data)                                  (0x00001FFF&(data))
...
#define  RIF_REG_RD_PRIORITY2_nm_src(data)                                       ((0x1FFF0000&(data))>>16)
#define  RIF_REG_RD_PRIORITY2_mvd_src(data)                                      (0x00001FFF&(data))
...
#define  RIF_REG_RD_PRIORITY3_gcoeff_src(data)                                   ((0x1FFF0000&(data))>>16)
#define  RIF_REG_RD_PRIORITY3_bs_src(data)                                       (0x00001FFF&(data))
...
#define  RIF_REG_RD_PRIORITY4_cmp_src(data)                                      ((0x1FFF0000&(data))>>16)
#define  RIF_REG_RD_PRIORITY4_rl_src(data)                                       (0x00001FFF&(data))
...
#define  RIF_REG_RD_PRIORITY5_fme_src(data)                                      ((0x1FFF0000&(data))>>16)
#define  RIF_REG_RD_PRIORITY5_ime_src(data)                                      (0x00001FFF&(data))
...
#define  RIF_REG_RD_PRIORITY6                                                   0x1800E4C8
#define  RIF_REG_RD_PRIORITY6_reg_addr                                           "0xB800E4C8"
#define  RIF_REG_RD_PRIORITY6_reg                                                0xB800E4C8
#define  RIF_REG_RD_PRIORITY6_inst_adr                                           "0x0032"
#define  RIF_REG_RD_PRIORITY6_inst                                               0x0032
#define  set_RIF_REG_RD_PRIORITY6_reg(data)                                      (*((volatile unsigned int*)RIF_REG_RD_PRIORITY6_reg)=data)
#define  get_RIF_REG_RD_PRIORITY6_reg                                            (*((volatile unsigned int*)RIF_REG_RD_PRIORITY6_reg))
#define  RIF_REG_RD_PRIORITY6_p2arb_shift                                        (0)
#define  RIF_REG_RD_PRIORITY6_p2arb_mask                                         (0x00001FFF)
#define  RIF_REG_RD_PRIORITY6_p2arb(data)                                        (0x00001FFF&(data))
#define  RIF_REG_RD_PRIORITY6_get_p2arb(data)                                    (0x00001FFF&(data))
#define  RIF_REG_RD_PRIORITY6_p2arb_src(data)                                    (0x00001FFF&(data))
...
#define  RIF_REG_FPGA_DBG1_clmp_busy_src(data)                                   ((0x40000000&(data))>>30)
#define  RIF_REG_FPGA_DBG1_alf_busy_src(data)                                    ((0x20000000&(data))>>29)
...
#define  RIF_REG_HEVCSEQCNTL_SHVC_enable_src(data)                               ((0x40000000&(data))>>30)
...
#define  RIF_REG_HEVCPICCNTL_decomp_en_src(data)                                 ((0x08000000&(data))>>27)
#define  RIF_REG_HEVCPICCNTL_large_scale_tile_src(data)                          ((0x04000000&(data))>>26)
#define  RIF_REG_HEVCPICCNTL_loop_filter_across_tiles_v_enabled_flag_src(data)   ((0x02000000&(data))>>25)
#define  RIF_REG_HEVCPICCNTL_picture_alf_enable_flag_src(data)                   ((0x01C00000&(data))>>22)
#define  RIF_REG_HEVCPICCNTL_transform_skip_enabled_flag_src(data)               ((0x00200000&(data))>>21)
#define  RIF_REG_HEVCPICCNTL_cu_qp_delta_enabled_flag_src(data)                  ((0x00100000&(data))>>20)
#define  RIF_REG_HEVCPICCNTL_min_cu_qp_delta_size_src(data)                      ((0x000E0000&(data))>>17)
#define  RIF_REG_HEVCPICCNTL_pic_cb_qp_offset_src(data)                          ((0x0001F800&(data))>>11)
#define  RIF_REG_HEVCPICCNTL_pic_cr_qp_offset_src(data)                          ((0x000007E0&(data))>>5)
...
#define  RIF_REG_SHVC_CTRL_inst_adr                                              "0x0016"
#define  RIF_REG_SHVC_CTRL_inst                                                  0x0016
...
#define  RIF_REG_SHVC_CTRL_luma_bits_CmOut_src(data)                             ((0x00000600&(data))>>9)
#define  RIF_REG_SHVC_CTRL_chroma_bits_CmOut_src(data)                           ((0x00000180&(data))>>7)
#define  RIF_REG_SHVC_CTRL_ctbSize_BaseLayer_src(data)                           ((0x00000060&(data))>>5)
#define  RIF_REG_SHVC_CTRL_luma_bits_BaseLayer_src(data)                         ((0x00000018&(data))>>3)
#define  RIF_REG_SHVC_CTRL_chroma_bits_BaseLayer_src(data)                       ((0x00000006&(data))>>1)
#define  RIF_REG_SHVC_CTRL_DualCoreEnable_BaseLayer_src(data)                    (0x00000001&(data))
...
#define  RIF_REG_REFPICSIZE_inst_adr                                             "0x0017"
#define  RIF_REG_REFPICSIZE_inst                                                 0x0017
...
#define  RIF_REG_REFPICSIZE_ref_pic_width_src(data)                              ((0x07FFE000&(data))>>13)
#define  RIF_REG_REFPICSIZE_ref_pic_height_src(data)                             (0x00001FFF&(data))

#define  RIF_REG_REFREGION                                                      0x1800E430
#define  RIF_REG_REFREGION_reg_addr                                              "0xB800E430"
#define  RIF_REG_REFREGION_reg                                                   0xB800E430
#define  RIF_REG_REFREGION_inst_adr                                              "0x000C"
#define  RIF_REG_REFREGION_inst                                                  0x000C
...
#define  RIF_REG_REFREGION_ref_region_width_src(data)                            ((0xFFFF0000&(data))>>16)
#define  RIF_REG_REFREGION_ref_region_height_src(data)                           (0x0000FFFF&(data))

#define  RIF_REG_REFOFFSET                                                      0x1800E434
#define  RIF_REG_REFOFFSET_reg_addr                                              "0xB800E434"
#define  RIF_REG_REFOFFSET_reg                                                   0xB800E434
#define  RIF_REG_REFOFFSET_inst_adr                                              "0x000D"
#define  RIF_REG_REFOFFSET_inst                                                  0x000D
...
#define  RIF_REG_REFOFFSET_ref_region_topoffset_src(data)                        ((0x3FFF8000&(data))>>15)
#define  RIF_REG_REFOFFSET_ref_region_leftoffset_src(data)                       (0x00007FFF&(data))
...
#define  RIF_REG_SCALEDREGION_inst_adr                                           "0x000E"
#define  RIF_REG_SCALEDREGION_inst                                               0x000E
...
#define  RIF_REG_SCALEDREGION_scaled_region_width_src(data)                      ((0xFFFF0000&(data))>>16)
#define  RIF_REG_SCALEDREGION_scaled_region_height_src(data)                     (0x0000FFFF&(data))
...
#define  RIF_REG_SCALEDOFFSET_inst_adr                                           "0x000F"
#define  RIF_REG_SCALEDOFFSET_inst                                               0x000F
...
#define  RIF_REG_SCALEDOFFSET_scaled_region_topoffset_src(data)                  ((0x3FFF8000&(data))>>15)
#define  RIF_REG_SCALEDOFFSET_scaled_region_leftoffset_src(data)                 (0x00007FFF&(data))
...
#define  RIF_REG_SHVC_ADDHORY_inst_adr                                           "0x0010"
#define  RIF_REG_SHVC_ADDHORY_inst                                               0x0010
...
#define  RIF_REG_SHVC_ADDHORY_new_addHorY_src(data)                              (0x3FFFFFFF&(data))
...
#define  RIF_REG_SHVC_ADDVERY_inst_adr                                           "0x0011"
#define  RIF_REG_SHVC_ADDVERY_inst                                               0x0011
...
#define  RIF_REG_SHVC_ADDVERY_new_addVerY_src(data)                              (0x3FFFFFFF&(data))
...
#define  RIF_REG_SHVC_ADDHORC_inst_adr                                           "0x0012"
#define  RIF_REG_SHVC_ADDHORC_inst                                               0x0012
...
#define  RIF_REG_SHVC_ADDHORC_new_addHorC_src(data)                              (0x3FFFFFFF&(data))
...
#define  RIF_REG_SHVC_ADDVERC_inst_adr                                           "0x0013"
#define  RIF_REG_SHVC_ADDVERC_inst                                               0x0013
...
#define  RIF_REG_SHVC_ADDVERC_new_addVerC_src(data)                              (0x3FFFFFFF&(data))
...
#define  RIF_REG_SCALE_FP_0_inst_adr                                             "0x001D"
#define  RIF_REG_SCALE_FP_0_inst                                                 0x001D
...
#define  RIF_REG_SCALE_FP_1_inst_adr                                             "0x001E"
#define  RIF_REG_SCALE_FP_1_inst                                                 0x001E
...
#define  RIF_REG_SCALE_FP_2_inst_adr                                             "0x001F"
#define  RIF_REG_SCALE_FP_2_inst                                                 0x001F
...
#define  RIF_REG_SCALE_FP_3_inst_adr                                             "0x0020"
#define  RIF_REG_SCALE_FP_3_inst                                                 0x0020
...
#define  RIF_REG_SCALE_FP_4_inst_adr                                             "0x0021"
#define  RIF_REG_SCALE_FP_4_inst                                                 0x0021
...
#define  RIF_REG_SCALE_FP_5_inst_adr                                             "0x0022"
#define  RIF_REG_SCALE_FP_5_inst                                                 0x0022
...
#define  RIF_REG_SCALE_FP_6_inst_adr                                             "0x0023"
#define  RIF_REG_SCALE_FP_6_inst                                                 0x0023
...
#define  RIF_REG_AV1PICCNTL_inst_adr                                             "0x002B"
#define  RIF_REG_AV1PICCNTL_inst                                                 0x002B
...
#define  RIF_REG_AV1PICCNTL_cdef_disable_src(data)                               ((0x00200000&(data))>>21)
#define  RIF_REG_AV1PICCNTL_allow_intrabc_src(data)                              ((0x00100000&(data))>>20)
#define  RIF_REG_AV1PICCNTL_blk_skip_enabled_src(data)                           ((0x00080000&(data))>>19)
#define  RIF_REG_AV1PICCNTL_delta_lf_multi_src(data)                             ((0x00040000&(data))>>18)
#define  RIF_REG_AV1PICCNTL_filter_level_v_src(data)                             ((0x0003F000&(data))>>12)
#define  RIF_REG_AV1PICCNTL_filter_level_u_src(data)                             ((0x00000FC0&(data))>>6)
#define  RIF_REG_AV1PICCNTL_filter_level_hor_src(data)                           (0x0000003F&(data))
