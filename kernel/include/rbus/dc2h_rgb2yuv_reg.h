...
#define  DC2H_RGB2YUV_DC2H_RGB2YUV_CTRL_cts_fifo_sync_rst_n_shift                (31)
#define  DC2H_RGB2YUV_DC2H_RGB2YUV_CTRL_cts_fifo_en_vs_rst_shift                 (30)
#define  DC2H_RGB2YUV_DC2H_RGB2YUV_CTRL_cts_fifo_en_bypass_shift                 (29)
#define  DC2H_RGB2YUV_DC2H_RGB2YUV_CTRL_dc2h_drop_en_shift                       (20)
...
#define  DC2H_RGB2YUV_DC2H_RGB2YUV_CTRL_cts_fifo_sync_rst_n_mask                 (0x80000000)
#define  DC2H_RGB2YUV_DC2H_RGB2YUV_CTRL_cts_fifo_en_vs_rst_mask                  (0x40000000)
#define  DC2H_RGB2YUV_DC2H_RGB2YUV_CTRL_cts_fifo_en_bypass_mask                  (0x20000000)
#define  DC2H_RGB2YUV_DC2H_RGB2YUV_CTRL_dc2h_drop_en_mask                        (0x00100000)
#define  DC2H_RGB2YUV_DC2H_RGB2YUV_CTRL_dc2h_in_sel_mask                         (0x000F0000)
...
#define  DC2H_RGB2YUV_DC2H_RGB2YUV_CTRL_cts_fifo_sync_rst_n(data)                (0x80000000&((data)<<31))
#define  DC2H_RGB2YUV_DC2H_RGB2YUV_CTRL_cts_fifo_en_vs_rst(data)                 (0x40000000&((data)<<30))
#define  DC2H_RGB2YUV_DC2H_RGB2YUV_CTRL_cts_fifo_en_bypass(data)                 (0x20000000&((data)<<29))
#define  DC2H_RGB2YUV_DC2H_RGB2YUV_CTRL_dc2h_drop_en(data)                       (0x00100000&((data)<<20))
#define  DC2H_RGB2YUV_DC2H_RGB2YUV_CTRL_dc2h_in_sel(data)                        (0x000F0000&((data)<<16))
...
#define  DC2H_RGB2YUV_DC2H_RGB2YUV_CTRL_get_cts_fifo_sync_rst_n(data)            ((0x80000000&(data))>>31)
#define  DC2H_RGB2YUV_DC2H_RGB2YUV_CTRL_get_cts_fifo_en_vs_rst(data)             ((0x40000000&(data))>>30)
#define  DC2H_RGB2YUV_DC2H_RGB2YUV_CTRL_get_cts_fifo_en_bypass(data)             ((0x20000000&(data))>>29)
#define  DC2H_RGB2YUV_DC2H_RGB2YUV_CTRL_get_dc2h_drop_en(data)                   ((0x00100000&(data))>>20)
#define  DC2H_RGB2YUV_DC2H_RGB2YUV_CTRL_get_dc2h_in_sel(data)                    ((0x000F0000&(data))>>16)
...
#define  DC2H_RGB2YUV_DC2H_Tab1_Yo_yo_odd_mask                                   (0x07FF0000)
#define  DC2H_RGB2YUV_DC2H_Tab1_Yo_yo_even_mask                                  (0x000007FF)
#define  DC2H_RGB2YUV_DC2H_Tab1_Yo_yo_odd(data)                                  (0x07FF0000&((data)<<16))
#define  DC2H_RGB2YUV_DC2H_Tab1_Yo_yo_even(data)                                 (0x000007FF&(data))
#define  DC2H_RGB2YUV_DC2H_Tab1_Yo_get_yo_odd(data)                              ((0x07FF0000&(data))>>16)
#define  DC2H_RGB2YUV_DC2H_Tab1_Yo_get_yo_even(data)                             (0x000007FF&(data))
...
typedef union
{
    RBus_UInt32 regValue;
    struct{
        RBus_UInt32  cts_fifo_sync_rst_n:1;
        RBus_UInt32  cts_fifo_en_vs_rst:1;
        RBus_UInt32  cts_fifo_en_bypass:1;
        RBus_UInt32  res1:8;
        RBus_UInt32  dc2h_drop_en:1;
        RBus_UInt32  dc2h_in_sel:4;
        RBus_UInt32  res2:4;
