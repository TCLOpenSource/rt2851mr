/**
* @file Merlin5_DesignSpec-I-Domain_Rgb2yuv
...
#define  RGB2YUV_ICH2_RGB2YUV_CTRL_sel_table_shift                               (2)
...
#define  RGB2YUV_ICH2_RGB2YUV_CTRL_sel_table_mask                                (0x00000004)
...
#define  RGB2YUV_ICH2_RGB2YUV_CTRL_sel_table(data)                               (0x00000004&((data)<<2))
...
#define  RGB2YUV_ICH2_RGB2YUV_CTRL_get_sel_table(data)                           ((0x00000004&(data))>>2)
