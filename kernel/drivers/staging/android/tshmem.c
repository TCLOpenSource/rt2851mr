...
#define ASHMEM_NAME_PREFIX "dev/tshmem/"
...
static int __init ashmem_init(void)
{
	...
	ashmem_area_cachep = kmem_cache_create("tshmem_area_cache",
	...
	ashmem_range_cachep = kmem_cache_create("tshmem_range_cache",
