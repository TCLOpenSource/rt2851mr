...
)
{
	...
	if (rf_path == (MAX_PATH_NUM_8822B - 1)) {
		...
		if (status == RT_STATUS_SUCCESS) {
			PHYDM_DBG(dm, ODM_COMP_TX_PWR_TRACK,
				...
				odm_get_bb_reg(dm, R_0xc94, BIT(29) | BIT(28) | BIT(27) | BIT(26) | BIT(25)),
				odm_get_bb_reg(dm, R_0xc1c, 0xFFE00000)
				     );
			PHYDM_DBG(dm, ODM_COMP_TX_PWR_TRACK,
				     "path B  0xE94=0x%X   0xE1C=0x%X\n",
				odm_get_bb_reg(dm, R_0xe94, BIT(29) | BIT(28) | BIT(27) | BIT(26) | BIT(25)),
	...
	if (method == BBSWING) {	/*use for mp driver clean power tracking status*/
		switch (rf_path) {
		case RF_PATH_A:
			odm_set_bb_reg(dm, R_0xc94, (BIT(29) | BIT(28) | BIT(27) | BIT(26) | BIT(25)), cali_info->absolute_ofdm_swing_idx[rf_path]);
			odm_set_bb_reg(dm, REG_A_TX_SCALE_JAGUAR, 0xFFE00000, tx_scaling_table_jaguar[cali_info->bb_swing_idx_ofdm[rf_path]]);
			break;
		case RF_PATH_B:
			odm_set_bb_reg(dm, R_0xe94, (BIT(29) | BIT(28) | BIT(27) | BIT(26) | BIT(25)), cali_info->absolute_ofdm_swing_idx[rf_path]);
