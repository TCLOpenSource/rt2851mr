...
)
{
	...
	/* 3 struct acs_info setting */
		...
		if (dm->support_ic_type & ODM_IC_11AC_SERIES) {
			...
			if (acs->acs_step == 0) {
				/* 4 Set IGI */
				odm_set_bb_reg(dm, R_0xc50, BIT(0) | BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(5) | BIT(6), 0x3E);
				if (get_rf_mimo_mode(priv) != RF_1T1R)
					odm_set_bb_reg(dm, R_0xe50, BIT(0) | BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(5) | BIT(6), 0x3E);
				...
				/* 4 Set IGI */
				odm_set_bb_reg(dm, R_0xc50, BIT(0) | BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(5) | BIT(6), 0x2A);
				if (get_rf_mimo_mode(priv) != RF_1T1R)
					odm_set_bb_reg(dm, R_0xe50, BIT(0) | BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(5) | BIT(6), 0x2A);
			...
			if (acs->acs_step == 0) {
				...
				odm_set_bb_reg(dm, R_0xc50, BIT(0) | BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(5) | BIT(6), 0x3E);
				if (get_rf_mimo_mode(priv) != RF_1T1R)
					odm_set_bb_reg(dm, R_0xc58, BIT(0) | BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(5) | BIT(6), 0x3E);
				...
				odm_set_bb_reg(dm, R_0xc50, BIT(0) | BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(5) | BIT(6), 0x2A);
				if (get_rf_mimo_mode(priv) != RF_1T1R)
					odm_set_bb_reg(dm, R_0xc58, BIT(0) | BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(5) | BIT(6), 0x2A);
