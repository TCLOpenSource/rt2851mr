...
#define SET_H2CCMD_CUSTOMERID(__pH2CCmd, __Value)                   SET_BITS_TO_LE_1BYTE(__pH2CCmd, 0, 6, __Value)
#define SET_H2CCMD_WOWLAN_CHANGE_UNIT_A(__pH2CCmd, __Value)         SET_BITS_TO_LE_1BYTE((__pH2CCmd), 6, 1, __Value)
#define SET_H2CCMD_SPECIAL_WAKE_REASON_A(__pH2CCmd, __Value)        SET_BITS_TO_LE_1BYTE((__pH2CCmd)+1, 0, 8, __Value)
#define SET_H2CCMD_WOWLAN_GPIO_DURATION_A(__pH2CCmd, __Value)       SET_BITS_TO_LE_1BYTE((__pH2CCmd)+2, 0, 7, __Value)
#define SET_H2CCMD_WOWLAN_GPIO_PULSE_EN_A(__pH2CCmd, __Value)       SET_BITS_TO_LE_1BYTE((__pH2CCmd)+3, 0, 1, __Value)
#define SET_H2CCMD_WOWLAN_GPIO_PULSE_COUNT_A(__pH2CCmd, __Value)    SET_BITS_TO_LE_1BYTE((__pH2CCmd)+3, 1, 7, __Value)
