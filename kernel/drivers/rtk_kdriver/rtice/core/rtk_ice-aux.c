...
void uart1_enable(void)
{
    ...
    rtd_maskl(0xb80008b8,0xFFFFFFF8,0x2); //src0:input mux
    rtd_maskl(0xb8060210,0xffffff0f,0x00000050); //rxdi:R872  Ps_Reg:st_gpio_02_ps 
    rtd_maskl(0xb8060210,0xffff0fff,0x00005000);//tx:R871  Ps_Reg:st_gpio_01_ps 
#if 0
