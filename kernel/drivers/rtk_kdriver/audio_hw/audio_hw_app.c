...
#if defined CONFIG_CUSTOMER_TV030
static int32_t g_adc1_offset = 10;
#else
...
int32_t Audio_AppInit(void)
{
...
#if defined CONFIG_CUSTOMER_TV030
	audio_analog_ci01_RBUS  analog_ci01;
#endif
	...
	// end
#if defined CONFIG_CUSTOMER_TV030
	analog_ci01.regValue = Audio_HwpReadRegister(AUDIO_analog_CI01_reg);
	analog_ci01.reg_bb_isel_vref=0x0;
	Audio_HwpWriteRegister(AUDIO_analog_CI01_reg, analog_ci01.regValue);
#endif
