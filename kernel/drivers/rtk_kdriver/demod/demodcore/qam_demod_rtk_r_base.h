...
#define REALTEK_R_QAM_BASE_DBG(fmt, args...)        rtd_printk_demod(KERN_DEBUG, "DEMO", "QAM_BASE_DEBUG, " fmt, ##args);
#define REALTEK_R_QAM_BASE_INFO(fmt, args...)       rtd_printk_demod(KERN_INFO, "DEMO", "QAM_BASE_INFO, " fmt, ##args);
#define REALTEK_R_QAM_BASE_WARNING(fmt, args...)    rtd_printk_demod(KERN_WARNING, "DEMO", "QAM_BASE_WARNING, " fmt, ##args);
