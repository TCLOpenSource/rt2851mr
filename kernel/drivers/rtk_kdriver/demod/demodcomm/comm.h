...
{            
    ...
    int (* SendWriteCommand)(struct sCOMM *comm, unsigned char DeviceAddr, unsigned char* pWritingBytes, unsigned char ByteNum,U32BITS Flags);
...
int Comm_SendWriteCommand(COMM* pCOMMKernel, unsigned char DeviceAddr, unsigned char* pWritingBytes, unsigned char ByteNum, U32BITS Flags);
