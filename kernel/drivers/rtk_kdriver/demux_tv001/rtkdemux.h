...
#define DEMUX_TP_BUFF_SIZE         (8*1024*1024)
...
#define DEMUX_VD_TLV_BS_SIZE         (12*1024*1024)
#define DEMUX_VD_TLV_IB_SIZE         (256*1024)
#define DEMUX_AD_TLV_BS_SIZE         (512*1024)
#define DEMUX_AD_TLV_IB_SIZE         (256*1024)
