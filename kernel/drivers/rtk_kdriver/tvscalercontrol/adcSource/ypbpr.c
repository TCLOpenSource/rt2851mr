...
{/* Do YPbPr coneect initial setting */
	...
	adc_adc_clamp_ctrl2_reg.adc_sog_cmp_5_4 = 0;/* SOG0 input MUX select (online)   01:VIN1P */
...
void YPbPr_DCRestore_Ctrl(unsigned char enable, ADC_DATA_PATH adc_path)
{
	...
	if (enable) {
		adc_adc_dcrestore_ctrl_reg.regValue = IoReg_Read32(ADC_ADC_DCRESTORE_CTRL_reg);
#if YPP_SOG0_VIN1P
		adc_adc_dcrestore_ctrl_reg.adc_dcrestore_ctrl_8 = 1;
		...
		adc_adc_dcrestore_ctrl_reg.adc_dcrestore_ctrl_2 = 1;
...
{	//input: _SRC_YPBPR, _SRC_AV
	...
	if(input == _SRC_YPBPR){
		...
		adc_ctl_rgb12_reg.adc_ctl_rgb1_7 = 0x1;
