...
void drvif_module_tve_video_memory_setting(unsigned char vflip_en)
{
	...
	if(vflip_en == false){
		...
		rtdf_outl(TVE_DMA_TVEVDDMA_SATRT0_reg,rtdf_inl(MDOMAIN_CAP_DDR_In2Addr_reg)/8);   //  dma addr	//和3d dma差了8倍
		...
		rtdf_outl(TVE_DMA_TVEVDDMA_SATRT0_reg,(rtdf_inl(MDOMAIN_CAP_DDR_In2Addr_reg)+TVE_VFLIP_SIZE_OFFSET)/8 );	  //  dma addr	//和3d dma差了8倍
