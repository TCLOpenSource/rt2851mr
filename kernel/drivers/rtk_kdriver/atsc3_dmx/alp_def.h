...
#define atsc_malloc(size)        kmalloc(size, GFP_KERNEL)//dvr_malloc(size)//kmalloc(size, GFP_KERNEL)
#define atsc_free(addr)          kfree(addr)//dvr_free(addr)//kfree(addr)
#define DMA_MEMCPY_EN            1
