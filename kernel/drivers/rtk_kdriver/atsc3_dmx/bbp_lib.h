...
//////////////////////////////////////////////
#if 0
#define BBP_WARNING(fmt, ...)       printf("[BBP] Warn, " fmt, __VA_ARGS__)
#define BBP_INFO(fmt, ...)          printf("[BBP] Info, " fmt, __VA_ARGS__)
//#define BBP_DBG(fmt, ...)           printf("[BBP] Dbg, " fmt, __VA_ARGS__)
#define BBP_DBG(fmt, ...)
#else
