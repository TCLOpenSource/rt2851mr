...
VOID HAL_POST_SetPatternSize(TIMING_PARA_ST stOutputTiming)
{
	...
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_patt_htotal),stOutputTiming.u32HTotal/4);
	//reg_post_patt_vtotal
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_patt_vtotal),stOutputTiming.u32VTotal);
	//reg_post_patt_hact
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_patt_hact),stOutputTiming.u32HActive);
	//reg_post_patt_vact
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_patt_vact),stOutputTiming.u32VActive);
}
...
{
	//reg_pr_mode_en
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__pr_mode_en),(UINT32)bEnable);
}
...
VOID HAL_POST_SetHdeCenterValue(UINT32 u32CenterValue)
{
	...
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__hde_center_value),u32CenterValue);
}
...
//	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__4port_hde_center_value),u32CenterValue);
}
...
{
	//reg_post_vsc_bypass
// MEMC_K6L_BRING_UP //	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_vsc_bypass),(UINT32)bEnable);
}
...
{
	//reg_post_vsc_mode
// MEMC_K6L_BRING_UP //	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_vsc_mode),u32Mode);
}
...
{
	//reg_post_v_act
// MEMC_K6L_BRING_UP //	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_v_act),u32Vactive);
}
...
{
	//reg_post_hsc_bypass
// MEMC_K6L_BRING_UP //	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_hsc_bypass),(UINT32)bEnable);
}
...
{
	//reg_post_hsc_mode_y
// MEMC_K6L_BRING_UP //	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_hsc_mode_y),u32Mode);
	//reg_post_hsc_mode_c
// MEMC_K6L_BRING_UP //	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_hsc_mode_c),u32Mode);
}
...
{
	//reg_post_hsc_ofst_y
// MEMC_K6L_BRING_UP //	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_hsc_ofst_y),u32Offset);
	//reg_post_hsc_ofst_c
// MEMC_K6L_BRING_UP //	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_hsc_ofst_c),u32Offset);
}
...
{
	//reg_post_hsc_coef_y
// MEMC_K6L_BRING_UP //	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_hsc_coef_y),u32Coef);
	//reg_post_hsc_coef_c
// MEMC_K6L_BRING_UP //	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_hsc_coef_c),u32Coef);
}
...
// MEMC_K6L_BRING_UP //	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_hsc_coef_y1),u32Coef);
	//reg_post_hsc_coef_c1
// MEMC_K6L_BRING_UP //	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_hsc_coef_c1),u32Coef);
}
...
{
	//reg_post_convert_on
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_convert_on),(UINT32)bEnable);
}
...
VOID HAL_POST_SetCSCMode(CSC_MODE enCSC_Mode)
{
	...
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_convert_mode),(UINT32)enCSC_Mode);
}
...
{
	//reg_bluescreen
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__bluescreen),(UINT32)bEnable);
}
...
{
	//reg_bluescreen_rgb
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__bluescreen_rgb),u32RGB);
}
...
VOID HAL_POST_SetDataMapping(UINT32 u32Data_Mapping)
{
	...
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_convert_map),(UINT32)u32Data_Mapping);
}
...
UINT32 HAL_POST_GetDataMapping(VOID)
{
	...
	//reg_post_convert_map
	ReadRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_convert_map),&u32Data_Mapping);
...
VOID HAL_POST_SetBlackInsertLineModeEnable(BOOL bEnable)
{
	...
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__blackinsert_line_en),(UINT32)bEnable);
}
...
VOID HAL_POST_SetBlackInsertLineModePatternNum(UINT32 u32PatternNum)
{
	...
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__blackinsert_line_type),u32PatternNum);
}
...
VOID HAL_POST_SetBlackInsertLineModeLPattern(UINT32 u32Pattern)
{
	...
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__blackinsert_line_patt_l),u32Pattern);
}
...
VOID HAL_POST_SetBlackInsertLineModeRPattern(UINT32 u32Pattern)
{
	...
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__blackinsert_line_patt_r),u32Pattern);
}
...
VOID HAL_POST_SetBlackInsertFrameModeEnable(BOOL bEnable)
{
	...
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__blackinsert_frame_en),(UINT32)bEnable);
}
...
VOID HAL_POST_SetOutINTSel(UINT32 u32Sel)
{
	...
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_out_int_sel),u32Sel);
}
...
VOID HAL_POST_SetOutINTSource(UINT32 u32Sor)
{
	...
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_int_source_sel),u32Sor);
}
...
VOID HAL_POST_SetOutINTHNum(UINT32 u32Hnum)
{
	...
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_out_vtotal_int),u32Hnum);
}
...
VOID HAL_POST_SetOutINTEnable(UINT32 u32IntType, BOOL bEnable)
{
	...
	ReadRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_int_en), &u32InINT_en);
	...
	//reg_post_int_en
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_int_en),u32InINT_en);
}
...
BOOL HAL_POST_GetOutINTEnable(UINT32 u32IntType)
{
	UINT32 v = 0;
       ...
       ReadRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_int_en),&v);
...
{
	//reg_post_cursor_en
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_cursor_en),(UINT32)bEnable);
}
...
VOID HAL_POST_SetCursorShow(BOOL bEnable)
{
	...
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_cursor_show),(UINT32)bEnable);
}
...
{
	//reg_post_cursor_h
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_cursor_h),(UINT32)u32Hposition);
	//reg_post_cursor_v
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_cursor_v),(UINT32)u32Vposition);
}
...
VOID HAL_POST_SetCursorWidth(UINT32 u32Width)
{
	...
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_cursor_h_width),(UINT32)u32Width);
}
...
{
	//reg_post_cursor_h_width
	WriteRegister(KIWI_REG(FRC_TOP__KPOST_TOP__post_cursor_color),(UINT32)u32Color);
}
