...
VOID HAL_IP_SetIPPRECSCEnable(BOOL bEnable)
{
	...
	{
		//reg_convert_on_h
		WriteRegister(KIWI_REG(FRC_TOP__IPPRE__convert_on_h),1);
		//reg_convert_on_l
		WriteRegister(KIWI_REG(FRC_TOP__IPPRE__convert_on_l),1);
	}
	else
	{
		//reg_convert_on_h
		WriteRegister(KIWI_REG(FRC_TOP__IPPRE__convert_on_h),0);	
		//reg_convert_on_l
		WriteRegister(KIWI_REG(FRC_TOP__IPPRE__convert_on_l),0);
	}
}
...
{
	//reg_convert_mode_h
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__convert_mode_h),(UINT32)enCSC_Mode);
	//reg_convert_mode_l
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__convert_mode_l),(UINT32)enCSC_Mode);
}
...
{
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__ippre_444to422_en), (UINT32)bEnable);
}
...
VOID HAL_IP_SetIPPRERetiming(UINT32 u32Hact, UINT32 u32Vact)
{
	...
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__ippre_retiming_hact),u32Hact/2);
	//reg_ippre_retiming_vact
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__ippre_retiming_vact),u32Vact);
}
...
{
	UINT32 uiVal = 0;
	ReadRegister(KIWI_REG(FRC_TOP__IPPRE__ippre_retiming_dummy_num), &uiVal);
	return uiVal;
}
...
{
	//reg_hact[11:0]
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__patt_hact),stInputTiming.u32HActive/2);
	//reg_vact[12:0]
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__patt_vact),stInputTiming.u32VActive);
	//reg_htotal[11:0]
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__patt_htotal),stInputTiming.u32HTotal/2);
	//reg_vtotal[11:0]
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__patt_vtotal),stInputTiming.u32VTotal);	
}
...
VOID HAL_IP_SetIPPREMuteUseMuteSyncEnable(BOOL bEnable)
{
	...
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__ippre_use_mute_vs), (UINT32)bEnable);
	//reg_ippre_use_mute_hs
	//WriteRegister(KIWI_REG(FRC_TOP__IPPRE__ippre_use_mute_hs), (UINT32)bEnable);
}
...
VOID HAL_IP_SetIPPREMuteSetMuteDetectEnable(BOOL bEnable)
{
	...
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__ippre_mute_det_function_en), (UINT32)bEnable);
}
...
{
	//reg_ippre_mute_hact
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__ippre_mute_hact), u32Hact);
	//reg_ippre_mute_hact_min
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__ippre_mute_hact_min), u32Hact_Min);
	//reg_ippre_mute_hact_max
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__ippre_mute_hact_max), u32Hact_Max);
}
...
{
	//reg_ippre_mute_vact
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__ippre_mute_vact), u32Vact);
	//reg_ippre_mute_vact_min
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__ippre_mute_vact_min), u32Vact_Min);
	//reg_ippre_mute_vact_max
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__ippre_mute_vact_max), u32Vact_Max);
}
...
VOID HAL_IP_SetIPPREMuteClockThreshold(UINT32 u32Clk_low_th, UINT32 u32Clk_high_th)
{
	...
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__ippre_mute_freq_low_th), u32Clk_low_th);
	//reg_ippre_mute_freq_high_th
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__ippre_mute_freq_high_th), u32Clk_high_th);
}
...
VOID HAL_IP_Set3DFSLRInverse(BOOL bEnable)
{
	...
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__patt_3d_fs_lr_inv),(UINT32)bEnable);	
}
...
{	
	WriteRegister(KIWI_REG(FRC_TOP__TOP_A__reg_sh13_out_ramp_en), (UINT32)bEnable);	
}
...
{	
	WriteRegister(KIWI_REG(FRC_TOP__TOP_B__reg_mute_force_freerun), (UINT32)bEnable);	
}
 ...
 * @retval VOID
*/
VOID HAL_IP_SetTOPBFRMTrigPosition(UINT32 u32Val)
{	
	WriteRegister(KIWI_REG(FRC_TOP__TOP_B__reg_mute_frm_trig_pos), u32Val);	
}
#endif
...
{
	//reg_convert_map_h
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__convert_map_h),(UINT32)u32Data_Mapping);	
	//reg_convert_map_l
	WriteRegister(KIWI_REG(FRC_TOP__IPPRE__convert_map_l),(UINT32)u32Data_Mapping);		
}
...
UINT32 HAL_IP_GetDataMapping(VOID)
{
	...
	//reg_convert_map_h
	ReadRegister(KIWI_REG(FRC_TOP__IPPRE__convert_map_h),&u32Data_Mapping);
