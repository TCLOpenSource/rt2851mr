...
#define RTD294x_MCP_AES_INI_KEY3                (RTD294x_REG_BASE + 0x15130)
 /* CAME Initial Key */
#define RTD294x_MCP_CAME_INI_KEY0                (RTD294x_REG_BASE + 0x1513C)
#define RTD294x_MCP_CAME_INI_KEY1                (RTD294x_REG_BASE + 0x15140)
#define RTD294x_MCP_CAME_INI_KEY2                (RTD294x_REG_BASE + 0x15144)
#define RTD294x_MCP_CAME_INI_KEY3                (RTD294x_REG_BASE + 0x15148)
/* Multi2 System Key */
...
#define MCP_CAME_INI_KEY0                           RTD294x_MCP_CAME_INI_KEY0
#define MCP_CAME_INI_KEY1                           RTD294x_MCP_CAME_INI_KEY1
#define MCP_CAME_INI_KEY2                           RTD294x_MCP_CAME_INI_KEY2
#define MCP_CAME_INI_KEY3                           RTD294x_MCP_CAME_INI_KEY3
