...
int optee_hdcp2_info_send(struct optee_rpc_param *p_hdcp2_info)
{
    struct arm_smccc_res res;
    
    p_hdcp2_info->a0 = OPTEE_SMC_HDCP2;

    arm_smccc_smc(p_hdcp2_info->a0,p_hdcp2_info->a1,p_hdcp2_info->a2,
                  p_hdcp2_info->a3,p_hdcp2_info->a4,p_hdcp2_info->a5,
                  p_hdcp2_info->a6,0,&res);
